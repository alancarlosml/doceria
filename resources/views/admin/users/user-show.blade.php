            ...
            <div class="md:flex md:items-center md:justify-between mb-8">
                ...
                <div class="mt-4 flex space-x-3 md:mt-0 md:ml-4">
                    ...
                    @if(auth()->user()->hasRole('admin') && $user->id !== auth()->id())
                        <a href="{{ route('users.permissions.manage', $user) }}" class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-purple-600 hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500">
                            <svg class="-ml-1 mr-2 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
