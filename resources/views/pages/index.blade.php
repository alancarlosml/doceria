...
<header class="store-header shadow-sm">
    ...
    <div class="flex-1">
        <h1 class="store-name">Doce Doce Brigaderia</h1>
        <div class="flex items-center gap-2 mt-0.5">
            <div class="w-2 h-2 rounded-full {{ App\Models\Setting::isStoreOpen() ? 'bg-green-500' : 'bg-red-500' }}"></div>
            <span class="text-xs {{ App\Models\Setting::isStoreOpen() ? 'text-green-600' : 'text-red-600' }}">
                {{ App\Models\Setting::isStoreOpen() ? 'Aberto' : 'Fechado' }}
            </span>
        </div>
    </div>
    <a href="https://wa.me/5598984419339" target="_blank" class="p-2 text-gray-500 hover:text-green-600 transition-colors">
...
<section class="bg-gradient-to-br from-pink-100 via-purple-50 to-green-100 py-12 px-4">
    <div class="container mx-auto text-center">
        ...
        <p class="text-gray-600 mb-4">Sabor e alegria em cada mordida!</p>
...
<section class="bg-gradient-to-br from-pink-100 via-purple-50 to-green-100 py-12 px-4">
    <div class="container mx-auto text-center max-w-2xl">
        ...
        <a href="https://wa.me/5598984419339?text={{ urlencode('Olá, gostaria de fazer um pedido personalizado!') }}"
           target="_blank"
           class="inline-flex items-center gap-3 bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-6 rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg">
